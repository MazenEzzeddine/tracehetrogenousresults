...
def hetero3alllag():
   ...
   # axx= axs[0].twinx()
    ...
    axs[1].plot(t5, r100, color='green', label='replicas 100 events/sec')
    axs[1].plot(t5, r250, color='brown', label='replicas 250 events/sec')
    ...
    axs[2].set_ylabel(('Event lag'), font=font)
    ...
    axs[2].plot(tlag, lag, color='red', label='Event Lag')
    #axx.plot(tlag, lag, color='red', label='Event Lag')
